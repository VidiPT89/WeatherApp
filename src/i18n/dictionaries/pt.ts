...
const pt: Dictionary = {
  ...
  marine: {
    ...
    subtitle: "Temperatura da água, ondulação e estimativa de marés — não substitui uma tábua de marés oficial.",
  ...
  insights: {
    title: "Mais sobre hoje",
    subtitle: "Algumas estimativas extra com base nas condições de hoje.",
    moonPhase: "Fase da lua",
    uvRisk: "Risco UV",
    outdoorActivity: "Atividades ao ar livre",
    fishingConditions: "Condições de pesca",
    moonPhases: {
      newMoon: "Lua Nova",
